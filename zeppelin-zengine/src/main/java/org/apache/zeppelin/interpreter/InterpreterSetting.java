...
public class InterpreterSetting {
    ...
    public static class Builder {
        ...
        public Builder setOption(InterpreterOption option) {
            interpreterSetting.option = Objects.requireNonNull(option, "param option can not be null");
            return this;
        }
    ...
    public void setOption(InterpreterOption option) {
        this.option = Objects.requireNonNull(option, "param option can not be null");
    }
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (tag.equals("id")) {
                    ...
                    List<InterpreterInfo> intpInfos = gson.fromJson(strIntpInfos, new TypeToken<List<InterpreterInfo>>() {
                    }.getType());
