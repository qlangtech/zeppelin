...
public class ZeppelinServer extends ResourceConfig {
    ...
    public static final String WEB_APP_CONTEXT_NEXT = "/next";
     ...
     * baisui add
     */
    public static void addWebContext(ZeppelinConfiguration conf, ServiceLocator sharedServiceLocator
            , Server jettyWebServer, HandlerCollection contexts, PrometheusMeterRegistry promMetricRegistry) throws IOException, InterruptedException {
...
//    setupClusterManagerServer(sharedServiceLocator);
        ...
        addWebContext(conf, sharedServiceLocator, jettyWebServer, contexts, promMetricRegistry);
    ...
    public static Thread shutdown(ZeppelinConfiguration conf) {
        return new Thread(
                () -> {
